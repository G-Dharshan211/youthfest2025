      ...
      <div className="container mx-auto px-4 py-6">
        <h1 
          className={`font-bold transition-all duration-700 ease-in-out pointer-events-auto ${
            isScrolled 
              ? 'text-2xl fixed top-4 left-4 bg-gray-900 px-4 py-2 rounded-lg shadow-lg text-[#77BEF0]' 
              : 'text-6xl md:text-8xl text-center animate-pulse text-[#FFCB61]'
          }`}
        >
          YOUTH FEST 2025
        </h1>
        {!isScrolled && (
          <div className="text-center mt-4 pointer-events-auto">
            ...
            <div className="mt-6 animate-bounce">
              <div className="w-6 h-10 border-2 border-[#FFCB61] rounded-full mx-auto">
                <div className="w-1 h-3 bg-[#FFCB61] rounded-full mx-auto mt-2 animate-pulse"></div>
              </div>
            </div>
          </div>
        )}
