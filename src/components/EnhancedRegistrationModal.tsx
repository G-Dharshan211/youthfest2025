    ...
    return (
      <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
        <div className="bg-gray-900 rounded-xl max-w-md w-full p-8 text-center border border-yellow-500/20">
          ...
          <h2 className="text-2xl font-bold text-yellow-400 mb-2">Registration Successful!</h2>
      ...
      <div className="bg-gray-900 rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto border border-yellow-500/20">
        <div className="relative p-6 border-b border-yellow-500/20">
          ...
          <div className="text-center">
            <h2 className="text-3xl font-bold text-yellow-400 mb-2">Join the Movement</h2>
            <p className="text-yellow-200">Register for Youth Fest 2025 and be part of something special</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 bg-gray-800 border rounded-lg text-yellow-100 focus:outline-none transition-colors ${
                  errors.name ? 'border-red-500' : 'border-yellow-500/30 focus:border-yellow-400'
                }`}
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full px-4 py-3 bg-gray-800 border rounded-lg text-yellow-100 focus:outline-none transition-colors ${
                  errors.email ? 'border-red-500' : 'border-yellow-500/30 focus:border-yellow-400'
                }`}
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full px-4 py-3 bg-gray-800 border rounded-lg text-yellow-100 focus:outline-none transition-colors ${
                  errors.phone ? 'border-red-500' : 'border-yellow-500/30 focus:border-yellow-400'
                }`}
            ...
            <div>
              ...
              <input
                ...
                max="30"
                className={`w-full px-4 py-3 bg-gray-800 border rounded-lg text-yellow-100 focus:outline-none transition-colors ${
                  errors.age ? 'border-red-500' : 'border-yellow-500/30 focus:border-yellow-400'
                }`}
              ...
              {availableEvents.map((eventName) => (
                <div key={eventName} className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-yellow-600 border-yellow-500/30 rounded focus:ring-yellow-400"
                  />
                  <label htmlFor={`event-${eventName}`} className="ml-2 text-yellow-200 text-sm">
                    {eventName}
                  </label>
                </div>
              ))}
          ...
          <div className="bg-gray-800 rounded-lg p-4 border border-yellow-500/20">
            <h3 className="text-yellow-400 font-semibold mb-2">Selected Event: {event.title}</h3>
          ...
          <button
            type="submit"
            className="w-full bg-yellow-500 text-gray-900 font-bold text-lg py-4 px-8 rounded-lg shadow-xl hover:bg-yellow-400 transition-all duration-300 transform hover:scale-105"
          >
            Register Now!
          </button>
        </form>
